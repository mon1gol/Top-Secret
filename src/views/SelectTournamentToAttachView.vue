<template>
  <div class="bg-white-one h-lvh pt-40">
    <AppContainer>
      <div class="md:flex md:space-x-15 space-y-15 md:justify-between">
        <div>
        ...
        <div class="">
          <img class="h-100 w-100 object-cover rounded-2xl shadow-2xl" :src="tournament.get_image" :alt="tournament.name">
        </div>
      </div>
    </AppContainer>
  </div>
