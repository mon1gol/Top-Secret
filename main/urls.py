...
urlpatterns = [
    ...
    path('tournaments/<slug:status_slug>/', views.TournamentsByStatus.as_view()),
    ...
    path('tournaments/<slug:category_slug>/<slug:tournament_slug>/teams/', views.TeamActions.as_view()),
]
